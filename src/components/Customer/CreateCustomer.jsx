...
const CreateCustomer = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm, setSubmitting }) => {
            ...
            try {
                const newValues = {
                    ...values,
                    opening_balance_date: formatDate(
                        values.opening_balance_date,
                        true
                    ),
                };
                const response = await dispatch(
                    createCustomer(newValues, navigate)
                );
    ...
    return (
        <div>
            <Breadcrumb
                item={{ label: "Customers", viewLabel: "Create Customers" }}
            />
                ...
                <div className="my-5 grid gap-5">
                    ...
                    <div className="bg-white rounded-md p-5">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            />
                            <div
                                className="w-full border rounded outline-none flex justify-between items-center pr-3 cursor-pointer"
                                onClick={() =>
                            ...
                            >
                                <DatePicker
                                    ref={datePickerRef}
                                    selected={
                                        formik.values.opening_balance_date
                                    }
                                    onChange={(date) =>
                                        formik.setFieldValue(
                                    ...
                                    className="w-full 2xl:w-[500px] p-3 border-none cursor-pointer"
