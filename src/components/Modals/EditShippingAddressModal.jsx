...
import { updateShippingAddress } from "../../Actions/Customer";
...
const EditShippingAddressModal = ({
    ...
    const formik = useFormik({
        initialValues: {
            label: currentShippingAddress?.label || "",
            address_line_1: currentShippingAddress?.address_line_1 || "",
            address_line_2: currentShippingAddress?.address_line_2 || "",
            address_line_3: currentShippingAddress?.address_line_3 || "",
            state: currentShippingAddress?.state || "Dubai",
            country: currentShippingAddress?.country || "United Arab Emirates",
        },
        ...
        onSubmit: (values, { resetForm, setSubmitting }) => {
            ...
            try {
                ...
                dispatch(
                    updateShippingAddress(values, shippingAddressId, customerId)
                );
                // resetForm();
                onClose();
