...
import { Input, Select, AutoComplete, Radio, Tooltip, Switch } from "antd";
import { MinusCircle, Plus, Info, ChevronUp, ChevronDown } from "lucide-react";
        ...
        <Fragment>
            ...
            {dueAmount ? (
                <div className="w-full px-4 my-5">
                    <div className="bg-white rounded-lg shadow-sm p-4">
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            >
                                <Radio value={1}>Payment Received</Radio>
                                <Radio value={2}>Payment Not Received</Radio>
                            </Radio.Group>
                        </div>
                                                    ...
                                                    (creditNote, index) => (
                                                        ...
                                                        >
                                                            <div className="flex items-center">
                                                                <input
                                                                    type="checkbox"
                                                                    checked={creditNoteList?.includes(
                                                                        creditNote?.cn_id
                                                                    )}
                                                                    onChange={(
                                                                        e
                ...
                <div className="flex justify-between gap-2 px-4 py-2">
                    {/* Linked Receipts */}
                    {linkReceipts?.length > 0 && (
                        <div className="w-1/2">
                            <h3 className="text-lg font-semibold text-gray-700 mb-3">
                                Linked Receipts
                            </h3>
                            <div className="grid grid-cols-1 gap-4">
                                {linkReceipts?.map((receipt) => (
                                    <div
                    ...
                    {/* Linked Credit Notes */}
                    {linkCreditNotes?.length > 0 && (
                        <div className="w-1/2">
                            <h3 className="text-lg font-semibold text-gray-700 mb-3">
                                Linked Credit Notes
                            </h3>
                            <div className="grid grid-cols-1 gap-4">
                                {linkCreditNotes?.map((creditNote) => (
                                    <div
